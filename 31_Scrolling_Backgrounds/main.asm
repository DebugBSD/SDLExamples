...
main proc 
	...
	.while quit!=1
		...
		dec dwScrollingOffset
		mov ebx, gBkgTexture.m_Width
		neg ebx
		cmp dwScrollingOffset, ebx
		jge @f
			mov dwScrollingOffset, 0
		@@: 
		...
		; Render Background
		invoke renderTexture, gRenderer, addr gBkgTexture, dwScrollingOffset, 0, 0, 0, 0, 0
		mov eax, dwScrollingOffset
		add eax, gBkgTexture.m_Width
		invoke renderTexture, gRenderer, addr gBkgTexture, eax, 0, 0, 0, 0, 0
