...
;	loop L1
	...
	.while quit!=1
		...
		invoke LTimer_Start, addr capTimer
		...
		fdiv result
		fistp dwAvgFps ; = countedFrames / (fpsTimer.GetTicks() / 1000)
		...
		invoke LTimer_GetTicks, addr capTimer
		.if eax < SCREEN_TICKS_PER_FRAME
			mov ebx, SCREEN_TICKS_PER_FRAME
			sub ebx, eax
			invoke SDL_Delay, eax  
		.endif
	.endw
